package de.tixus.mb.opac.shared;
...
public class FieldVerifier {
   ...
   * complex checks to ensure that usernames, passwords, email addresses, URLs, and other fields have the proper syntax.
   * 
  ...
  public static boolean isWhiteSpaceSeparatedName(final String name) {
    if (name == null) {
      return false;
    }
